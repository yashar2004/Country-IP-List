...
:do { add address=2001:505:150::/48 list=LCv6 } on-error={}
...
:do { add address=149.112.194.0/23 list=IP-LC } on-error={}
...
:do { add address=167.150.204.0/22 list=IP-LC } on-error={}
