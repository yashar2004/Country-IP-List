...
:do { add address=2001:43ff:a800::/48 list=RW-IPv6 } on-error={}
...
:do { add address=102.202.79.0/24 list=RW-IPv4 } on-error={}
:do { add address=102.202.96.0/22 list=RW-IPv4 } on-error={}
