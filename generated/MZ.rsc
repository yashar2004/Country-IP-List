...
:do { add address=102.201.140.0/22 list=MZ-IPv4 } on-error={}
:do { add address=102.202.10.0/24 list=MZ-IPv4 } on-error={}
:do { add address=102.202.76.0/24 list=MZ-IPv4 } on-error={}
