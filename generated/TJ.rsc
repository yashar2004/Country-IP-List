...
:do { add address=2a0a:f2c0::/29 list=TJ-IPv6 } on-error={}
...
:do { add address=2a0e:6840::/29 list=TJ-IPv6 } on-error={}
...
:do { add address=168.113.229.0/24 list=TJ-IPv4 } on-error={}
...
:do { add address=194.238.47.0/24 list=TJ-IPv4 } on-error={}
...
:do { add address=213.193.194.0/24 list=TJ-IPv4 } on-error={}
