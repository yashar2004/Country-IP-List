...
:do { add address=190.2.160.0/21 list=CW-IPv4 } on-error={}
:do { add address=190.2.168.0/22 list=CW-IPv4 } on-error={}
:do { add address=190.2.180.0/22 list=CW-IPv4 } on-error={}
